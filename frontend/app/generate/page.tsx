  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-gradient text-black">
      ...
      <div className="flex justify-between items-center p-8">
        ...
        <button
          className="px-5 py-1 rounded-full font-semibold bg-gradient-to-b from-blue-500 to-blue-600 text-white focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200 cursor-pointer"
